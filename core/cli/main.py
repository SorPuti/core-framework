...
def cmd_gentypes(args: argparse.Namespace) -> int:
    ...
    Usage:
        core gentypes              # Gera ambos os arquivos
        core gentypes --models     # Apenas tipos de models
        core gentypes --settings   # Apenas stub de settings
    ...
    print(bold("🔧 Core Framework Type Generator"))
    print()
    ...
    if generate_settings:
        ...
        stub_lines = [
            ...
            '',
            'from core.config import get_settings as _get_settings, Settings',
            ...
            '    ',
            '    Este é um wrapper tipado de core.config.get_settings().',
            '    """',
    ...
    if generate_models:
        ...
        try:
            ...
            print(warning("  core.db não disponível - pulando geração de tipos de models"))
        ...
        if Base is not None:
            ...
            for mapper in Base.registry.mappers:
                ...
                if module.startswith("core.admin.models") or module.startswith("core.auth.models"):
