...
class TestDenyAll:
    ...
    async def test_denies_anonymous(self):
        ...
        from strider.permissions import DenyAll
...
class TestIsAuthenticatedOrReadOnly:
    ...
    async def test_allows_anonymous_read(self):
        ...
        from strider.permissions import IsAuthenticatedOrReadOnly
...
class TestIsAdmin:
    ...
    async def test_denies_anonymous(self):
        """Test denies anonymous users."""
        from strider.permissions import IsAdmin
...
class TestIsOwner:
    ...
    async def test_general_permission_always_true(self):
        ...
        from strider.permissions import IsOwner
...
class TestPermissionCombination:
    ...
    async def test_and_permission(self):
        ...
        from strider.permissions import IsAuthenticated, IsAdmin
