...
Uso:
    from strider.auth import get_auth_backend, register_auth_backend
...
class ModelBackend(AuthBackend):
    ...
    def user_model(self) -> type:
        ...
        from strider.auth.models import AbstractUser
        return AbstractUser
...
class MultiBackend(AuthBackend):
    ...
    async def authenticate(
        ...
        **credentials: Any,
        ...
        from strider.auth.base import get_auth_backend
