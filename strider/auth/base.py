...
def coerce_user_id(user_model: type, user_id: str | int | Any) -> Any:
    ...
    Example:
        from strider.auth.base import coerce_user_id
...
def configure_auth(config: AuthConfig | None = None, **kwargs) -> AuthConfig:
    ...
    from strider.dependencies import configure_auth as configure_deps
    from strider.auth.tokens import verify_token
        ...
        try:
            ...
            if hasattr(config.user_model, "__table__"):
                ...
                if pk_cols and isinstance(pk_cols[0].type, (PG_UUID, Uuid)):
                    ...
                    from strider.auth.models import PermissionsMixin
...
def check_middleware_configured(app: Any = None) -> bool:
    ...
    Args:
        app: FastAPI or StrideApp instance (optional)
...
def get_auth_setup_checklist() -> str:
    ...
    checklist.append("   from strider.auth import AuthenticationMiddleware")
    checklist.append("   app = StrideApp(middlewares=[(AuthenticationMiddleware, {})])")
