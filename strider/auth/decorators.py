...
Uso:
    from strider.auth import require_permission, require_group, login_required
...
from strider.permissions import Permission as PermissionBase
...
class HasPermission(PermissionBase):
    ...
    async def has_permission(
        ...
        if not hasattr(user, "has_perm"):
            ...
            from strider.auth.base import get_permission_backend
