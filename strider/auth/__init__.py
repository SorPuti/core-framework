...
Exemplo de backend customizado:
    from strider.auth import AuthBackend, register_backend
...
from strider.auth.hashers import (
    PBKDF2Hasher,
    Argon2Hasher,
    BCryptHasher,
    ScryptHasher,
...
from strider.auth.backends import (
    ModelBackend,
    TokenAuthBackend,
)

from strider.auth.permissions import (
...
# Views
from strider.auth.views import (
    AuthViewSet,
)
