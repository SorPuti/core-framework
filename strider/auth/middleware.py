...
Usage:
    from strider.auth.middleware import AuthenticationMiddleware
...
class JWTAuthBackend(AuthenticationBackend):
    ...
    async def _verify_and_get_user(self, token: str) -> Any | None:
        ...
        """
        from strider.auth.tokens import verify_token, decode_token
        from strider.auth.base import TokenError
    ...
    async def _get_db_session(self) -> "AsyncSession | None":
        ...
        try:
            from strider.database import _read_session_factory
