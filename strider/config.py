...
class Settings(BaseSettings):
    ...
    middleware: list[str] = PydanticField(
        ...
        Formatos aceitos:
        - String path: "strider.auth.AuthenticationMiddleware"
        - Shortcut: "auth", "timing", "logging", etc
        
        Exemplo:
            MIDDLEWARE='["timing", "auth", "strider.middleware.LoggingMiddleware"]'
...
def _configure_auth_from_settings() -> None:
    ...
    """
    from strider.auth.base import get_auth_config, configure_auth
...
def _auto_configure_datetime(settings: Settings) -> bool:
    ...
    try:
        from strider.datetime import configure_datetime
...
def _auto_configure_auth(settings: Settings) -> bool:
    ...
    try:
        from strider.auth import configure_auth as _configure_auth
