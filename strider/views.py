...
from strider.dependencies import get_db, DatabaseSession
from strider.permissions import Permission, AllowAny, check_permissions
...
from strider.querysets import DoesNotExist
...
def validate_pending_viewsets(*, strict: bool | None = None) -> list[str]:
    ...
    """
    import logging
    logger = logging.getLogger("strider.views")
...
class ViewSet(Generic[ModelT, InputT, OutputT]):
    ...
    def _validate_schemas(cls) -> list[str]:
        ...
        try:
            ...
            import logging
            logging.getLogger("strider.views").warning(
