...
logger = logging.getLogger("strider.middleware")
...
class BaseMiddleware(BaseHTTPMiddleware):
    ...
    def _fallback_error_response(self, request: Request, exc: Exception) -> Response:
        """Resposta de erro garantida quando on_error não trata. Traceback no stderr e no log."""
        import sys
        import traceback
...
_builtin_middlewares: dict[str, str] = {
    # Auth
    "auth": "strider.auth.middleware.AuthenticationMiddleware",
    "authentication": "strider.auth.middleware.AuthenticationMiddleware",
    "optional_auth": "strider.auth.middleware.OptionalAuthenticationMiddleware",
    
    # Tenancy
    "tenant": "strider.tenancy.TenantMiddleware",
    "tenancy": "strider.tenancy.TenantMiddleware",
    ...
    "timing": "strider.middleware.TimingMiddleware",
    "request_id": "strider.middleware.RequestIDMiddleware",
    "logging": "strider.middleware.LoggingMiddleware",
    "maintenance": "strider.middleware.MaintenanceModeMiddleware",
    "security_headers": "strider.middleware.SecurityHeadersMiddleware",
    "rate_limit": "strider.middleware.RateLimitMiddleware",
    "content_length_limit": "strider.middleware.ContentLengthLimitMiddleware",
}
...
class LoggingMiddleware(ASGIMiddleware):
    ...
    logger_name: str = "strider.requests"
