...
EQUIVALENT_TYPES: dict[str, set[str]] = {
    ...
    "FLOAT": {"FLOAT", "FLOAT4", "REAL", "DOUBLE", "DOUBLE PRECISION", "FLOAT8"},
    "REAL": {"FLOAT", "FLOAT4", "REAL"},
    "DOUBLE": {"DOUBLE", "DOUBLE PRECISION", "FLOAT8", "FLOAT"},
    "DOUBLE PRECISION": {"DOUBLE", "DOUBLE PRECISION", "FLOAT8", "FLOAT"},
    ...
    for attr_name in dir(model_class):
        ...
        try:
            ...
            if isinstance(attr, type):
                ...
                try:
                    from strider.choices import Choices
...
def models_to_schema_state(models: list[type["Model"]]) -> SchemaState:
    ...
    if models:
        from strider.models import Model as BaseModel
...
# Estas tabelas são gerenciadas pelo Stride e não devem ser
