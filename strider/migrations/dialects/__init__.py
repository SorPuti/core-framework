...
Usage:
    from strider.migrations.dialects import get_compiler
...
def get_compiler(dialect: str) -> "DialectCompiler":
    ...
    if not _COMPILERS:
        from strider.migrations.dialects.sqlite import SQLiteCompiler
        from strider.migrations.dialects.postgresql import PostgreSQLCompiler
        from strider.migrations.dialects.mysql import MySQLCompiler
