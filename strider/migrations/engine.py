...
from strider.migrations.operations import (
    Operation,
    CreateTable,
    DropTable,
    AddColumn,
...
from strider.migrations.state import (
    SchemaState,
    SchemaDiff,
    TableState,
    ColumnState,
...
if TYPE_CHECKING:
    ...
    from strider.migrations.dialects.base import DialectCompiler
...
class MigrationEngine:
    ...
    def _diff_to_operations(self, diff: SchemaDiff) -> list[Operation]:
        ...
        from strider.migrations.operations import CreateEnum, DropEnum, AlterEnum
    ...
    def _generate_migration_code(
        ...
        from strider.migrations.operations import get_serialization_imports
