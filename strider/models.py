...
class Field:
    ...
    def struct(
        ...
        *,
        ...
        """
        from strider.fields import AdaptiveJSON
        from strider.schema import StructSchema, StructDescriptor
...
async def create_tables() -> None:
    ...
    """
    import logging
    _log = logging.getLogger("strider.database")
...
class SoftDeleteManager[T: "Model"](Manager[T]):
    ...
    def _create_queryset(self) -> "SoftDeleteQuerySet[T]":
        ...
        from strider.querysets import SoftDeleteQuerySet
...
class TenantSoftDeleteManager[T: "Model"](SoftDeleteManager[T]):
    ...
    def _create_queryset(self) -> "TenantSoftDeleteQuerySet[T]":
        ...
        from strider.querysets import TenantSoftDeleteQuerySet
