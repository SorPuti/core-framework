"""
Centralized exception classes for the Stride.
...
Example:
    from strider.exceptions import NotFound, ValidationException, PermissionDenied
...
class StrideException(Exception):
    """
    Base exception for all Stride exceptions.
...
class ValidationException(StrideException):
    """
...
class DatabaseException(StrideException):
...
class AuthException(StrideException):
...
class BusinessException(StrideException):
    """
...
class ConfigurationError(StrideException):
    """
