...
from strider.admin.exceptions import AdminRegistrationError
from strider.admin.types import (
    ModelT,
    WidgetConfig,
    FieldsetConfig,
    IconType,
...
class ModelAdmin(Generic[ModelT]):
    ...
    def get_storage_file_fields(self) -> list[str]:
        ...
        """
        try:
            from strider.storage import get_storage_file_fields as _get_storage_file_fields
