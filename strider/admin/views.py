...
from strider.admin.permissions import check_admin_access, check_model_permission
from strider.admin.serializers import serialize_instance
...
def create_api_views(site: Any) -> APIRouter:
    ...
    async def get_metadata(
        ...
        return {
            ...
            "site_header": getattr(site._settings, "admin_site_header", "Stride Admin"),
            "user": {
    ...
    async def list_view(
        ...
        try:
            async with db:
                ...
                from strider.querysets import QuerySet as _QS
                ...
                from strider.admin.options import _detect_enum
                columns_meta = []
        ...
        try:
            async with db:
                ...
                if delete_physical_files:
                    from strider.storage import get_storage_file_fields, collect_file_paths, delete_file
...
async def _log_action(
    ...
    try:
        from strider.admin.models import AuditLog
