...
logger = logging.getLogger("strider.admin.ops")
...
def create_ops_api(site: "AdminSite") -> APIRouter:
    ...
    async def task_retry(
        ...
        try:
            ...
            from strider.admin.models import TaskExecution
            from strider.querysets import QuerySet
            from strider.tasks.registry import get_task, get_task_producer
            from strider.tasks.base import TaskMessage
            import uuid
    ...
    async def periodic_list(
        ...
        from strider.tasks.registry import get_periodic_tasks
    ...
    async def resource_inventory(
        ...
        from strider.admin.resource_inventory import ResourceInventory
    ...
    async def topics_registered(
        ...
        try:
            from strider.messaging.topics import get_all_topics, Topic
    ...
    async def schemas_avro(
        ...
        try:
            from strider.messaging.avro import AvroModel
...
async def _get_kafka_admin():
    ...
    try:
        if backend == "confluent":
            from strider.messaging.confluent import ConfluentAdmin
