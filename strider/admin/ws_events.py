...
from strider.admin.event_tracking import subscribe_events, unsubscribe_events

if TYPE_CHECKING:
    from strider.admin.site import AdminSite

logger = logging.getLogger("strider.admin.ws_events")
...
async def broadcast_worker_heartbeat(worker_data: dict) -> None:
    ...
    """
    from strider.admin.event_tracking import broadcast_event
