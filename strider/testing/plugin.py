...
if TYPE_CHECKING:
    ...
    from strider.testing.mocks import MockKafka, MockRedis, MockHTTP

logger = logging.getLogger("strider.testing")
...
def _init_test_settings():
    ...
    try:
        ...
        logger.debug("strider.config not available, skipping settings init")
...
def _init_test_database():
    ...
    try:
        ...
        logger.debug("strider.database not available, skipping database init")
    except Exception as e:
...
def _init_test_auth():
    ...
    try:
        from strider.auth.base import configure_auth, AuthConfig
        ...
        logger.debug("strider.auth not available, skipping auth init")
    except Exception as e:
...
def _init_test_middleware():
    ...
    try:
        from strider.middleware import clear_middleware_registry
        clear_middleware_registry()
        logger.debug("Middleware registry cleared")
    except ImportError:
        logger.debug("strider.middleware not available")
    except Exception as e:
...
async def db(test_engine) -> "AsyncSession":
    ...
    try:
        ...
        pytest.skip("strider.database not available")
...
async def auth_client(app, test_engine) -> "AsyncClient":
    ...
    try:
        from strider.testing import AuthenticatedClient
        
        async with AuthenticatedClient(app) as c:
            yield c
    except ImportError:
        pytest.skip("strider.testing.AuthenticatedClient not available")
    except Exception as e:
...
def mock_kafka() -> "MockKafka":
    ...
    """
    from strider.testing.mocks import MockKafka
...
def mock_redis() -> "MockRedis":
    ...
    """
    from strider.testing.mocks import MockRedis
...
def mock_http() -> "MockHTTP":
    ...
    """
    from strider.testing.mocks import MockHTTP
...
def fake():
    ...
    from strider.testing.factories import fake
    return fake
...
def user_factory():
    ...
    from strider.testing.factories import UserFactory
    return UserFactory
...
def assert_status():
    ...
    from strider.testing.assertions import assert_status
...
def assert_json():
    ...
    from strider.testing.assertions import assert_json_contains
