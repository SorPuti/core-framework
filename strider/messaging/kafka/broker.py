...
producing, consuming, and topic management.
"""
...
from strider.messaging.base import MessageBroker
...
from strider.messaging.kafka.admin import KafkaAdmin
...
class KafkaBroker(MessageBroker):
    ...
    Provides a unified interface for all Kafka operations.
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._admin: KafkaAdmin | None = None
    ...
    async def create_topic(
        ...
        """
        if not self._admin:
            self._admin = KafkaAdmin(bootstrap_servers=self._bootstrap_servers)
            await self._admin.connect()
    ...
    def get_consumer(self, group_id: str) -> KafkaConsumer | None:
