"""
Stride - Enterprise Messaging System.
...
Quick Start:
    from strider.messaging import publish, Topic
...
Workers:
    from strider.messaging import worker, Worker
...
Configuration:
    # Settings (settings.py / .env) or environment variables
    [messaging]
...
from strider.messaging.base import (
    MessageBroker,
    Producer,
    Consumer,
    Event,
...
from strider.messaging.config import (
    MessagingSettings,
    get_messaging_settings,
    configure_messaging,
)
from strider.messaging.decorators import (
    event,
    consumer,
    on_event,
)
from strider.messaging.registry import (
    get_broker,
    get_producer,
    register_broker,
    register_consumer,
...
from strider.messaging.topics import (
    Topic,
    EventTopic,
    CommandTopic,
    StateTopic,
...
from strider.messaging.avro import (
    AvroModel,
    avro_schema,
)
