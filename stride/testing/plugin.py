...
if TYPE_CHECKING:
    ...
    from stride.testing.mocks import MockKafka, MockRedis, MockHTTP

logger = logging.getLogger("stride.testing")
...
def _init_test_settings():
    ...
    try:
        ...
        logger.debug("stride.config not available, skipping settings init")
...
def _init_test_database():
    ...
    try:
        ...
        logger.debug("stride.database not available, skipping database init")
    except Exception as e:
...
def _init_test_auth():
    ...
    try:
        from stride.auth.base import configure_auth, AuthConfig
        ...
        logger.debug("stride.auth not available, skipping auth init")
    except Exception as e:
...
def _init_test_middleware():
    ...
    try:
        from stride.middleware import clear_middleware_registry
        clear_middleware_registry()
        logger.debug("Middleware registry cleared")
    except ImportError:
        logger.debug("stride.middleware not available")
    except Exception as e:
...
async def db(test_engine) -> "AsyncSession":
    ...
    try:
        ...
        pytest.skip("stride.database not available")
...
async def auth_client(app, test_engine) -> "AsyncClient":
    ...
    try:
        from stride.testing import AuthenticatedClient
        
        async with AuthenticatedClient(app) as c:
            yield c
    except ImportError:
        pytest.skip("stride.testing.AuthenticatedClient not available")
    except Exception as e:
...
def mock_kafka() -> "MockKafka":
    ...
    """
    from stride.testing.mocks import MockKafka
...
def mock_redis() -> "MockRedis":
    ...
    """
    from stride.testing.mocks import MockRedis
...
def mock_http() -> "MockHTTP":
    ...
    """
    from stride.testing.mocks import MockHTTP
...
def fake():
    ...
    from stride.testing.factories import fake
    return fake
...
def user_factory():
    ...
    from stride.testing.factories import UserFactory
    return UserFactory
...
def assert_status():
    ...
    from stride.testing.assertions import assert_status
...
def assert_json():
    ...
    from stride.testing.assertions import assert_json_contains
