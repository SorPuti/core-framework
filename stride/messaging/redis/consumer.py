...
from stride.messaging.base import Consumer, Event
from stride.config import get_settings
from stride.messaging.registry import get_event_handlers
...
class RedisConsumer(Consumer):
    ...
    async def _process_entry(self, stream: str, entry_id: str, entry_data: dict) -> None:
        ...
        from stride.messaging.tracking import track_incoming
