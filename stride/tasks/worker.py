...
from stride.tasks.base import TaskMessage, TaskResult, TaskStatus
from stride.config import get_settings
from stride.tasks.registry import get_task
...
class TaskWorker:
    ...
    async def start(self) -> None:
        ...
        if self._persist_enabled:
            try:
                from stride.models import init_database
        ...
        from stride.messaging.registry import create_consumer
        ...
        try:
            ...
            async with db:
                ...
                try:
                    ...
                    from stride.admin.ws_events import broadcast_worker_heartbeat
    ...
    async def _retry_task(self, task_msg: TaskMessage) -> None:
        """Retry a failed task."""
        from stride.tasks.registry import get_task_producer
        from datetime import timedelta
