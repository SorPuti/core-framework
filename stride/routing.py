...
from stride.dependencies import get_db, get_optional_user
...
if TYPE_CHECKING:
    from stride.views import ViewSet, APIView

logger = logging.getLogger("stride.routing")
...
class Router(APIRouter):
                ...
                def make_action_endpoint(
                    ...
                    if with_body:
                        ...
                        async def action_endpoint(
                            ...
                            if perm_classes:
                                from stride.permissions import check_permissions
    ...
    def register_websocket(
        ...
        """
        from stride.realtime import WebSocketView
    ...
    def register_sse(
        ...
        **kwargs: Any,
        ...
        """
        from stride.realtime import SSEView
