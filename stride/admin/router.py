...
from stride.admin.permissions import check_admin_access, _get_admin_user
...
def create_admin_router(site: "AdminSite", settings: "Settings") -> APIRouter:
    ...
    if ops_enabled:
        from stride.admin.ops_views import create_ops_api
        ops_router = create_ops_api(site)
        router.include_router(ops_router)
        
        # WebSocket endpoint for real-time updates
        from stride.admin.ws_events import create_ws_router
        ws_router = create_ws_router(site)
        router.include_router(ws_router)
        
        from stride.admin.log_handler import setup_log_buffer
        setup_log_buffer()
    ...
    from stride.admin.views import create_api_views
    ...
    async def login_action(
        ...
        try:
            ...
            async with db:
                ...
                try:
                    from stride.admin.models import AdminSession
    ...
    async def model_list(
        ...
        from stride.admin.permissions import get_user_model_permissions
