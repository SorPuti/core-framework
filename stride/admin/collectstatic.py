...
Responsabilidades:
1. Copiar assets do Stride (stride/admin/static/stride-admin/)
...
def collectstatic(
    ...
    Args:
        output_dir: Diretório destino (default: ./static/stride-admin)
    ...
    Returns:
        Dict com estatísticas:
        {
            "files_copied": 15,
            "conflicts": [],
            "manifest_path": "static/stride-admin/manifest.json",
            "output_dir": "static/stride-admin",
        }
    """
    cwd = Path(os.getcwd())
    ...
    core_static = Path(__file__).parent / "static" / "stride-admin"
