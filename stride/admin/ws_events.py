...
from stride.admin.event_tracking import subscribe_events, unsubscribe_events

if TYPE_CHECKING:
    from stride.admin.site import AdminSite

logger = logging.getLogger("stride.admin.ws_events")
...
async def broadcast_worker_heartbeat(worker_data: dict) -> None:
    ...
    """
    from stride.admin.event_tracking import broadcast_event
