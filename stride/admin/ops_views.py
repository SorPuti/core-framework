...
from stride.admin.permissions import check_admin_access

if TYPE_CHECKING:
    from stride.admin.site import AdminSite

logger = logging.getLogger("stride.admin.ops")
...
def create_ops_api(site: "AdminSite") -> APIRouter:
    ...
    async def infrastructure_view(
        ...
        from stride.admin.infrastructure import InfraDetector
    ...
    async def tasks_list(
        ...
        try:
            ...
            from stride.admin.models import TaskExecution
    ...
    async def task_retry(
        ...
        try:
            ...
            from stride.admin.models import TaskExecution
            from stride.querysets import QuerySet
            from stride.tasks.registry import get_task, get_task_producer
            from stride.tasks.base import TaskMessage
            import uuid
    ...
    async def periodic_list(
        ...
        from stride.tasks.registry import get_periodic_tasks
    ...
    async def workers_list(
        ...
        try:
            from stride.models import get_session
            from stride.admin.models import WorkerHeartbeat
            from stride.querysets import QuerySet
            from stride.datetime import timezone
            from datetime import timedelta
    ...
    async def logs_recent(
        ...
        from stride.admin.log_handler import get_log_buffer
    ...
    async def resource_inventory(
        ...
        from stride.admin.resource_inventory import ResourceInventory
    ...
    async def kafka_throughput(
        ...
        try:
            from stride.models import get_session
            from stride.admin.models import EventLog
            from stride.datetime import timezone
            from datetime import timedelta
            from sqlalchemy import select, func
    ...
    async def topics_registered(
        ...
        try:
            from stride.messaging.topics import get_all_topics, Topic
    ...
    async def schemas_avro(
        ...
        try:
            from stride.messaging.avro import AvroModel
        ...
        try:
            ...
            async with db:
                ...
                if backend == "confluent":
                    ...
                    from stride.messaging.kafka import KafkaProducer
...
async def _get_kafka_admin():
    ...
    try:
        if backend == "confluent":
            from stride.messaging.confluent import ConfluentAdmin
