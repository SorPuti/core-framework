...
Uso:
    from stride.auth import get_token_backend, create_access_token
...
logger = logging.getLogger("stride.auth.tokens")
...
def create_access_token(
    ...
    """
    from stride.auth.base import get_token_backend
