...
Uso:
    from stride.auth import get_password_hasher, register_password_hasher
...
from stride.auth.base import PasswordHasher, register_password_hasher
...
class MultiHasher(PasswordHasher):
    ...
    def _get_hasher(self, algorithm: str) -> PasswordHasher:
        if algorithm not in self._hashers:
            from stride.auth.base import get_password_hasher
