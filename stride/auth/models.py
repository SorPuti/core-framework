...
from stride.auth.base import get_password_hasher, get_auth_config
from stride.datetime import timezone, DateTime
from stride.choices import ThemeOptions
...
class AbstractUser(Model):
    ...
    def check_password(self, raw_password: str) -> bool:
        ...
        if algorithm:
            try:
                from stride.auth.base import get_password_hasher as get_hasher
...
def get_user_model() -> type | Any:
    ...
    Example:
        from stride.auth import get_user_model
    ...
    """
    from stride.auth.base import get_auth_config
