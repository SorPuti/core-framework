"""
Authentication Middleware for Stride.
...
Usage:
    from stride.auth.middleware import AuthenticationMiddleware
...
class JWTAuthBackend(AuthenticationBackend):
    ...
    async def _verify_and_get_user(self, token: str) -> Any | None:
        ...
        """
        from stride.auth.tokens import verify_token, decode_token
        from stride.auth.base import TokenError
    ...
    async def _get_db_session(self) -> "AsyncSession | None":
        ...
        try:
            from stride.database import _read_session_factory
    ...
    def _convert_user_id(self, user_id: str, User: type) -> Any:
        ...
        try:
            from stride.auth.models import _get_pk_column_type
