...
def coerce_user_id(user_model: type, user_id: str | int | Any) -> Any:
    ...
    Example:
        from stride.auth.base import coerce_user_id
...
def configure_auth(config: AuthConfig | None = None, **kwargs) -> AuthConfig:
    ...
    from stride.dependencies import configure_auth as configure_deps
    from stride.auth.tokens import verify_token
        ...
        try:
            ...
            if hasattr(config.user_model, "__table__"):
                ...
                if pk_cols and isinstance(pk_cols[0].type, (PG_UUID, Uuid)):
                    ...
                    from stride.auth.models import PermissionsMixin
...
def get_auth_setup_checklist() -> str:
    ...
    checklist.append("   from stride.auth import AuthenticationMiddleware")
