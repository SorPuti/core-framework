...
logger = logging.getLogger("stride.middleware")
...
_builtin_middlewares: dict[str, str] = {
    # Auth
    "auth": "stride.auth.middleware.AuthenticationMiddleware",
    "authentication": "stride.auth.middleware.AuthenticationMiddleware",
    "optional_auth": "stride.auth.middleware.OptionalAuthenticationMiddleware",
    
    # Tenancy
    "tenant": "stride.tenancy.TenantMiddleware",
    "tenancy": "stride.tenancy.TenantMiddleware",
    ...
    "timing": "stride.middleware.TimingMiddleware",
    "request_id": "stride.middleware.RequestIDMiddleware",
    "logging": "stride.middleware.LoggingMiddleware",
    "maintenance": "stride.middleware.MaintenanceModeMiddleware",
    "security_headers": "stride.middleware.SecurityHeadersMiddleware",
    "rate_limit": "stride.middleware.RateLimitMiddleware",
    "content_length_limit": "stride.middleware.ContentLengthLimitMiddleware",
}
...
class LoggingMiddleware(ASGIMiddleware):
    ...
    logger_name: str = "stride.requests"
