...
from stride.dependencies import get_db, DatabaseSession
from stride.permissions import Permission, AllowAny, check_permissions
...
from stride.querysets import DoesNotExist
...
def validate_pending_viewsets(*, strict: bool | None = None) -> list[str]:
    ...
    """
    import logging
    logger = logging.getLogger("stride.views")
...
class ViewSet(Generic[ModelT, InputT, OutputT]):
    ...
    def _validate_schemas(cls) -> list[str]:
        ...
        try:
            ...
            import logging
            logging.getLogger("stride.views").warning(
