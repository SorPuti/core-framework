...
from stride.migrations.dialects import detect_dialect, get_compiler
...
def _engine_from_args(
    ...
    """Build a MigrationEngine from common CLI/API arguments (reduces duplication)."""
...
async def makemigrations(
    ...
    """
    engine = _engine_from_args(database_url, migrations_dir, app_label)
...
async def migrate(
    ...
    Exemplo:
        from stride.migrations import migrate
...
async def squash(
    ...
    Exemplo:
        from stride.migrations import squash
...
def run_cli():
    ...
    Uso:
        ...
        python -m stride.migrations showmigrations
        python -m stride.migrations rollback
        python -m stride.migrations dbinfo
    """
    import argparse
    
    parser = argparse.ArgumentParser(
        description="Stride Migration CLI (prefer: stride migrate / stride makemigrations)",
        prog="python -m stride.migrations",
    )
    ...
    if args.command == "makemigrations":
        ...
        print("  from stride.migrations import makemigrations")
