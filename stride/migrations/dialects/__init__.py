...
Usage:
    from stride.migrations.dialects import get_compiler
...
def get_compiler(dialect: str) -> "DialectCompiler":
    ...
    if not _COMPILERS:
        from stride.migrations.dialects.sqlite import SQLiteCompiler
        from stride.migrations.dialects.postgresql import PostgreSQLCompiler
        from stride.migrations.dialects.mysql import MySQLCompiler
